...
import my.example.bobatap.ReusableCode.ReusableCodeForAll;
import my.example.bobatap.models.Passwords;
import my.example.bobatap.models.Users;
import my.example.bobatap.models.privatedetails;
...
//******************************FUNCTIONS TO ADD DATA'S TO FIREBASE*************************
    public void addUsers(String Discription,String FullName,String Username,String Website){
        ...
        Users user = new Users(
                ...
                FullName,
                "0",
                "https://firebasestorage.googleapis.com/v0/b/socialmediaapp-ddbb6.appspot.com/o/generalProfilePhoto%2Fnodp.jpg?alt=media&token=14c65f07-d1cd-4c78-91f8-6ea5f335c48a",
                Username,
                Website,
                useridd
        );
